...
/** 
 * DAO for table "T__SYS__CONTANTS".
*/
public class T_SYS_CONTANTSDao extends AbstractDao<TSYSCONTANTS, String> {

    public static final String TABLENAME = "T__SYS__CONTANTS";

    /**
     * Properties of entity T_SYS_CONTANTS.<br/>
    ...
    */
    ...
    public T_SYS_CONTANTSDao(DaoConfig config) {
        super(config);
    }
    
    public T_SYS_CONTANTSDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"T__SYS__CONTANTS\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"T__SYS__CONTANTS\"";
        db.execSQL(sql);
    }
