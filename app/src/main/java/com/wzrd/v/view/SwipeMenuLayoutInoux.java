 ...
 * Date: 16/04/24
 */
public class SwipeMenuLayoutInoux extends ViewGroup {
    ...
    //存储的是当前正在展开的View
    private static SwipeMenuLayoutInoux mViewCache;
    ...
    public SwipeMenuLayoutInoux(Context context) {
        this(context, null);
    }

    public SwipeMenuLayoutInoux(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeMenuLayoutInoux(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param ios
     */
    public SwipeMenuLayoutInoux setIos(boolean ios) {
        isIos = ios;
        return this;
    }
     ...
     * @return
     */
    public SwipeMenuLayoutInoux setLeftSwipe(boolean leftSwipe) {
     ...
     * @return
     */
    public static SwipeMenuLayoutInoux getViewCache() {
        return mViewCache;
    }
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
        ...
        invalidate();*/
        //展开就加入ViewCache：
        mViewCache = SwipeMenuLayoutInoux.this;
