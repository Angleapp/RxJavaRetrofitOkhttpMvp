...
import com.wzrd.m.utils.ScreenUtil;
...
public class TimeSelector {
    ...
    public TimeSelector(Context context, ResultHandler resultHandler, String startDate, String endDate) {
        ...
        startCalendar.setTime(DateUtils.parse("00:00", FORMAT_STR));
        endCalendar.setTime(DateUtils.parse("23:00", FORMAT_STR));
        initDialog();
        initView();
    }
